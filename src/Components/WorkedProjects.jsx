...
const workedProjects = [
  {
    ...
    role: "Dev Engineer",
    project: "Connected Car Data Platform",
    ...
    techStack: ["Java", "Spring Boot", "REST APIs", "JWT", "PostgreSQL", "Linux", "Git"]
  },
  {
    ...
    techStack: ["Java", "Spring Boot", "MySQL", "Digio", "Swagger", "Postman", "GitHub"]
  },
  {
    ...
    techStack: ["PHP", "WordPress", "MySQL", "HTML", "CSS", "JavaScript", "cPanel"]
  },
//   {
...
//   description: "Set up and managed Jira on Data Center for enterprise-level usage. Created and configured multiple Jira projects with optimal workflows, permissions, automations, and dashboards.",
//   responsibilities: [
...
//   ],
//   techStack: [
//     "Jira Data Center", "Jira Service Management", "Linux", "PostgreSQL", "Nginx", "Automation Rules"
//   ]
// }
      ...
      <div className="worked-projects-container">
        {workedProjects.map((project, index) => (
          <div className="worked-project-card" key={index}>
            ...
            <p><strong>Technologies Used:</strong> {project.techStack.join(", ")}</p>
          </div>
        ))}
      </div>
    </section>
